...
- **supervise** — manage background services (scheduler, gateway, chromium): status, up, down, restart, logs (`tail`). Run 'status' first when browser/search/schedule/gateway fail.
